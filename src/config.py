...
DEFAULT_RATE_LIMIT_PACING_USAGE_RATIO = float(
    os.getenv("X_RATE_LIMIT_PACING_USAGE_RATIO", "0.35")
)
DEFAULT_RATE_LIMIT_PACING_FACTOR = float(
    os.getenv("X_RATE_LIMIT_PACING_FACTOR", "1.15")
)
DEFAULT_RATE_LIMIT_MIN_INTERVAL_SECONDS = float(
    os.getenv("X_RATE_LIMIT_MIN_INTERVAL_SECONDS", "0.5")
)
DEFAULT_RATE_LIMIT_MAX_INTERVAL_SECONDS = float(
    os.getenv("X_RATE_LIMIT_MAX_INTERVAL_SECONDS", "15")
)
